...
class dist_t
{
  public:
    ...
    bool has_pipe (slk::pipe_t *pipe_);
    ...
    int send_to_matching (slk::msg_t *msg_);

    //  Send the message to all the outbound pipes.
    int send_to_all (slk::msg_t *msg_);
  ...
  private:
    ...
    bool write (slk::pipe_t *pipe_, slk::msg_t *msg_);

    //  Put the message to all active pipes.
    void distribute (slk::msg_t *msg_);

    //  List of outbound pipes.
    typedef array_t<slk::pipe_t, 2> pipes_t;
    pipes_t _pipes;
