...
#ifndef SL_PIPE_HPP_INCLUDED
#define SL_PIPE_HPP_INCLUDED

#include "../util/ypipe_base.hpp"
...
int pipepair (slk::object_t *parents_[2],
              slk::pipe_t *pipes_[2],
              const int hwms_[2],
...
{
    virtual ~i_pipe_events () = default;

    virtual void read_activated (slk::pipe_t *pipe_) = 0;
    virtual void write_activated (slk::pipe_t *pipe_) = 0;
    virtual void hiccuped (slk::pipe_t *pipe_) = 0;
    virtual void pipe_terminated (slk::pipe_t *pipe_) = 0;
};
                         ...
                         public array_item_t<3>
{
    ...
    friend int pipepair (slk::object_t *parents_[2],
                         slk::pipe_t *pipes_[2],
                         const int hwms_[2],
                         const bool conflate_[2]);
  ...
  private:
    ...
    SL_NON_COPYABLE_NOR_MOVABLE (pipe_t)
};
