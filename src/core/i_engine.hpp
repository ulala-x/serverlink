...
#ifndef SL_I_ENGINE_HPP_INCLUDED
#define SL_I_ENGINE_HPP_INCLUDED
...
struct i_engine
{
    ...
    virtual void plug (slk::io_thread_t *io_thread_,
    ...
    //  Not used in ServerLink (ZAP removed), but kept for interface compatibility
