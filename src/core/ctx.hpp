...
class ctx_t : public thread_ctx_t
{
  public:
    ...
    // This function is called when user invokes slk_ctx_term. If there are
  ...
  private:
    ...
    // we can notify the sockets when slk_ctx_term() is called.
    ...
    // If true, slk_init has been called but no socket has been created
    // yet. Launching of I/O threads is delayed
    bool _starting;

    // If true, slk_ctx_term was already called
    bool _terminating;
    ...
    // Mailbox for slk_ctx_term thread
    ...
    static void
    connect_inproc_sockets (slk::socket_base_t *bind_socket_,
