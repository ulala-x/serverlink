...
#ifndef SL_DBUFFER_HPP_INCLUDED
#define SL_DBUFFER_HPP_INCLUDED
...
template <> class dbuffer_t<msg_t>
{
  public:
    ...
    {
        slk_assert (value_.check ());
        *_back = value_;

        slk_assert (_back->check ());
  ...
  private:
    ...
    SL_NON_COPYABLE_NOR_MOVABLE (dbuffer_t)
};
}
